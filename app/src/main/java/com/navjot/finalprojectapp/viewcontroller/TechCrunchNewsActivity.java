...
import com.navjot.finalprojectapp.MainActivity;
...
public class TechCrunchNewsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    class FetchNewsTask extends AsyncTask{
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            try{
//https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=defa38b00b0d4852b428b66f62433b92
               // https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=defa38b00b0d4852b428b66f62433b92
              ...
              //  URL url = new URL("https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=defa38b00b0d4852b428b66f62433b92");
                URL url = new URL("https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=defa38b00b0d4852b428b66f62433b92");
